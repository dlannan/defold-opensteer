...
local SimpleStatic = function() 
    ...
    self._curvature = 0.0
    self._lastForward = new Vec3()
    self._lastPosition = new Vec3()
    ...
    self.setMass = function(m) return self._mass = m end
    ...
    self.setSpeed = function(s) return self._speed = s end

    -- // size of bounding sphere, for obstacle avoidance, etc.
    self.radius = function() return self._radius end
    self.setRadius = function(m) return self._radius = m end

    -- // get/set maxForce
    self.maxForce = function() return self._maxForceend
    self.setMaxForce = function(mf) return self._maxForce = mf end

    -- // get/set maxSpeed
    self.maxSpeed = function()  return self._maxSpeedend
    self.setMaxSpeed = function(ms) return self._maxSpeed = ms end
